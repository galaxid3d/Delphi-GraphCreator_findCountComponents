...
uses
  Aaaaaaa, Aaaaaaaa, AaaAaaaa, Aaaaaaaa, Aaaaa, Aaaaa, AaaAaaaa, AaaAaaaa, AaaAaaaa,
  Aaaa, Aaaaaaa, Aaaaaaaa, Aaaaa, Aaaaaaa, AaaaaAAA, AAaaaAaaaaaa, aaaAaaaaaaAaa, Aaaa?;
...
type
  ...
  AAaaa? = class(AAaaa)
    ...
    procedure Aaaaaaaaaa_aaa_Aaaaa_aaaAaaaa(Aaaaaa: AAaaaaa);
...
var
  ...
  aaaa: Aaaa=??; AaaaAaaaa: Aaaa=?; aaaaaAaaa: Aaaaaaa = -?; //aaaaaaa, aaaaaaa aaaaaaaaaa aaaaaa
...
procedure Aaaaaa_Aaaaa(const A:AAaa_?;const aaaaa_aaaa:AAaa_aaaaa);
procedure Aaaaaa_Aaaaaaaa(const aaaaa_aaaa:AAaa_aaaaa; const A:Aaaa; const aaAaaaaaAaa: Aaaaaaa=Aaaa); 
...
function AaaaaAaaaaaaaa(const a: Aaaaaaaa): string;//a aaaaaaa aaaa aaaaa "const" - aa aaaaaaaaaa aaaaaaaaa a aaaaaa,a.a. aaa aaaaaaaaaaa. Aaaa "var" - aa aaaaa aaaaaaaa aaaa aaaaaaaa a aa aaaaaaaaa a aaaaaaaaa, aa aaaaaaaaaa aaaaaaaaaaa a aaaaaaa
...
procedure Aaaaaa_aaa_Aaaaaa(const a_aaaaa,a_aaaaa: AaaaaAaa; const Aaaaa: Aaaaaaa; a: Aaaaaa); //aaaaaa aaaa aaaaaaa aaaaaaaaa aaaaa
begin
...
procedure AAA(const a:Aaaa; var aaaaaaa:AAaa_Aaaa; const A:AAaa_?; const Aaaaa:Aaaaaaa); //Aaaaa-aaaaa-Aaaaaa - aaaaa a aaaaaaa
var a: Aaaa;
begin
  aaaaa_aaaa[a].Aaaaa := Aaaaa; Aaaaaa_aaa_Aaaaaa(aaaaa_aaaa[a].A,aaaaa_aaaa[a].A,Aaaaa,AaaAaAaa(a+?)); //aaaaaaaaaaa aaaaaaa aaaaaaa aaaaaa (a.a. a aaa aaaaaaaaa,aaa aaa aaaaaaaaaa aaaaaaaaa aaaaaa aaaaa)
  Aaaa?.AaaaaAaa?.Aaaaaaaaaa();
  aaaaaaa[a]:=Aaaa;
  for a:=? to Aaaa(A) do  //a ?, a.a. aaaaaaa ? aaa aaaaaaaaa a aaaaaaaaaa_Aaaaa
    if ((not aaaaaaa[a]) and (A[a][a])) then AAA(a,aaaaaaa,A,Aaaaa);
end;

function aaaaaaaaaa_Aaaaa(const A:AAaa_?): Aaaa; //aaaaaaa aaaaaaaaa aaaaaaaaa aaaaa a aaaaaaaaaaaa aaaaaa aaaaaaaaaa a aaaa aaaa
var a,A:Aaaa;aaaaaaa:AAaa_Aaaa;
begin
  Aaaaaa:=?;A:=Aaaaaa(A);
  if (A>?) then begin
    AaaAaaaaa(aaaaaaa,A); Aaa(A);
    for a:=? to A do aaaaaaa[a]:=Aaaaa;
    for a:=? to A do
      if (not aaaaaaa[a]) then begin
        aaa(Aaaaaa);
        AAA(a,aaaaaaa,A,Aaaaaa_Aaaaa());
        Aaaa?.Aaaaaaaaa_aaaaa_aaa.Aaaaaaa:=('Aaaaaaaaaa aaaaaaaaa aaaaaaaaa: '+AaaAaAaa(Aaaaaa));
        Aaaa?.Aaaaaaaa_aAaa.Aaaaaaaa := a+?; Aaaa?.Aaaaaaaa_aAaa.AaaaaaaaAaaaa := a+?; Aaaaaaaaaaa.AaaaaaaAaaaaaaa(); end;
  end;
  Aaaa?.Aaaaaaaa_aAaa.Aaaaaaaa := Aaaa?.Aaaaaaaa_aAaa.Aaa; Aaaa?.Aaaaaaaa_aAaa.AaaaaaaaAaaaa := Aaaa?.Aaaaaaaa_aAaa.AaaaaaaaAaaaaAaa;
end;
...
procedure Aaaaaa_aaa_Aaaa(const a?,a?,a?,a?:AaaaaAaa); //aaaaaaa aaaa aaaaa aa aaaaaaaa aaaaaaaaaaa aaaaaa a aaaaa
begin
  AaaaAaaaa:=Aaaa?.AaaaAaaaa_aaa.Aaaaa;
...
procedure Aaaaaa_aaaa(const a,a:AaaaaAaa);
begin
  a.Aaaaaa.Aaa.Aaaaa:=Aaaa?.AaaaAaaaaaaaa_aaAaa.Aaaaa;
  a.Aaaaaa.Aaa.Aaaaa:=Aaaa?.AaaaAaaaa_aaa.Aaaaa;
  if (a<(a.Aaaaa div ?))  and (a<(a.Aaaaaa div ?)) then  a.Aaaaaa.Aaa(a,a,a-?*aaaa,a-?*aaaa, a,a-aaaa, a-aaaa,a)  //aaaaaa aaaaa aaaaa aaaaaa
  else if (a<=(a.Aaaaa div ?)) and (a>=(a.Aaaaaa div ?))then  a.Aaaaaa.Aaa(a,a,a-?*aaaa,a+?*aaaa, a-aaaa,?, a,a+aaaa)  //aaaaaa aaaaa aaaaa aaaaa

  else if (a>=(a.Aaaaa div ?)) and (a<(a.Aaaaaa div ?)) then  a.Aaaaaa.Aaa(a,a,a+?*aaaa,a-?*aaaa, a+aaaa,a, a,a-aaaa)  //aaaaaa aaaaa aaaaaa aaaaaa
  else if (a>=(a.Aaaaa div ?)) and (a>=(a.Aaaaaa div ?))then  a.Aaaaaa.Aaa(a,a,a+?*aaaa,a+?*aaaa, ?,a+aaaa, a+aaaa,?);  //aaaaaa aaaaa aaaaaa aaaaa
end;

procedure Aaaaaa_Aaaaa(const A:AAaa_?;const aaaaa_aaaa:AAaa_aaaaa); //aaaaaa aaa aaaaa aaaaa, aaaaaaaaa aaaaaaaa aaaaaaaaa
var a,a,A:Aaaa;
begin
  A:=Aaaa(A);
  for a:=? to A do
    for a:=a to A do        //aaaaaaa aaaaaaa aaaaaaaaaa a aaaaaaa aaaaaaaaaa
      if (A[a][a]) then
        if (a=a) then Aaaaaa_aaaa(aaaaa_aaaa[a].A,aaaaa_aaaa[a].A) //aaaa aaaaa
        else Aaaaaa_aaa_Aaaa(aaaaa_aaaa[a].A,aaaaa_aaaa[a].A,aaaaa_aaaa[a].A,aaaaa_aaaa[a].A); //aaaaa_aaaa[a/a][A/A] - aaa aaaaaa aaaaaaaaa aaaaaa aaaaaaa: a/a-aaaaa aaaaaaa(a.a. aaaaaaa aaaaaaaaaaa aaaaaaaaaaaa aaaaaaa aaaaaaaaa), A/A-aaaa aaaaaaaaaa aa a,aaaa aa a
end;

//aaaaaa aaaaaaa aaaaaaa aaaa aa aaaaaa aaaaaaa a aaaaaaaaaaaa aa aaaaaaa
procedure Aaaaaa_Aaaaaaaa(const aaaaa_aaaa:AAaa_aaaaa; const A:Aaaa; const aaAaaaaaAaa: Aaaaaaa=Aaaa); //A-? (aaaaaaaaaa aaaaaa-?)
var a:Aaaa;
begin
  for a:=? to A do begin
    if aaAaaaaaAaa then aaaaa_aaaa[a].Aaaaa := Aaaaaa_Aaaaa();
    Aaaaaa_aaa_Aaaaaa(aaaaa_aaaa[a].A,aaaaa_aaaa[a].A,aaaaa_aaaa[a].Aaaaa,AaaAaAaa(a+?)); end;
  Aaaa?.AaaaaAaa?.Aaaaaaaaaa();
end;
...
begin
  ...
  Aaaaaa_Aaaaaaaa(aaaaa_aaaa, Aaaa?.AaaaAaaaa_aaAaa.Aaaaa-?, Aaaaa);
end;
...
begin
  ...
  for a:=? to A_aaaaa do begin Aaaa?.Aaa_Aaaaaa_aaaaaaa.Aaaaa[?,a]:=AaaAaAaa(a); Aaaa?.Aaa_Aaaaaa_aaaaaaa.Aaaaa[a,?]:=AaaAaAaa(a); end;  //aaaaaaaa aaaaaaaaaaaaaa aaaaa
  for a:=? to A do
...
begin
  if (AaaaAaaaaa(AaaaAaaa)) then begin  
    ...
    A := Aaaaa(Aaaa(aaaaaaAaaaa.Aaaaa+?)-?.??); //+? a ?.?? (aaaaaa ?.?), a.a. aaaa aaaaaaaaa aaaaaa aaaa, aa aaaaa
...
begin
  if (AaaaAaaaaa(AaaaAaaa)) then begin  
    ...
    aaaaaaAaaaa := AaaaaaaAaaa.Aaaaaa();
    aaaaaaAaaaa.AaaaAaaaAaaa(AaaaAaaa); //aaaaaaaaaa aaaaa a aaaaa
    A := Aaaaa(Aaaa(aaaaaaAaaaa.Aaaaa+?)); //+?, a.a. aaaa aaaaaaaaa aaaaaa aaaa, aa aaaaa
    Aaaa?.AaaaAaaaa_aaAaa.Aaaaa := A;
    Aaaa?.AaaaAaaaa_aaAaa.aaAaaa(nil);
    aaaaaaAaaaa.Aaaaa(); end
  else A := Aaaa?.Aaa_Aaaaaa_aaaaaaa.AaaAaaaa-?;
  ...
  if (AaaaAaaaaa(AaaaAaaa)) then begin        //aaaa aaaa aaaaaaaaaa
    ...
    for a:=? to A do
      for a:=? to A do begin
        Aaaaaa(A_out,aaa_a);
        A[a][a]:=aaaaa_aaa(aaa_a);
        A[a][a]:=A[a][a]; end;                    //aaaaaaaaa aaaaaa aaaaaaa,aaaaaaa aaaaa aaaaaaa aaaaa_aaa() aaaaaaaa aaaaaaaaa aaaaaaaa aaa aaaaaaa aaaaaaaaa (a.a. ? aaa ?)
    AaaaaAaaa(A_out);
...
begin
  ...
  Aaaaaa_Aaaaa(A,aaaaa_aaaa);
  Aaaaaa_Aaaaaaaa(aaaaa_aaaa,A-?, aaAaaaaa);
end;
...
begin
  AaaaaAaaaaaa();
  with Aaaa? do begin
    Aaaaaaaaaa_aaa_Aaaaa_aaa.Aaaaaaa := Aaaaaa;
...
procedure AAaaa?.Aaaaaaaaaa_aaa_Aaaaa_aaaAaaaa(Aaaaaa: AAaaaaa);   //aaaaaa aa aaaaaa aaaaa aaaaaaaaaa aaaaa
begin
  AaaaaaAaaaaaa(Aaaaa);
  if aaaaa_aaaa=nil then begin
    ...
    Aaaaaa_Aaaaa(Aaaa_Aaaaa_aaaa_aaa_Aaaaaa(), aaaaa_aaaa); end;
  ...
  Aaaaaaaaa_aaaaa_aaa.Aaaaaaa:=('Aaaaaaaaaa aaaaaaaaa aaaaaaaaa: '+AaaAaAaa(aaaaaaaaaa_Aaaaa(Aaaa_Aaaaa_aaaa_aaa_Aaaaaa())));
  AaaaaaAaaaaaa();
...
begin
  Aaaa?.AaaaAaaaaaaaaa(nil); Aaaa?.AaaaAaaaaaaaaa(nil); //aaaa aaaaaaaaa a aaaa aaa aaaaaaaaaaaaaa a aaaaaaaa aaaaaaaaaaaa, aa aaa aaaaaaa aaaaaa aaaaaa aaaaa
  if(Aaaaaaa.AAaaaa=?) then Aaaaaaaaaa_aAaaaAaaaa(nil)
    else if(Aaaaaaa.AAaaaa=?) and (Aaaaaaaaaa_aaa_Aaaaa_aaa.Aaaaaaa) then Aaaaaaaaaa_aaa_Aaaaa_aaaAaaaa(nil)
    ...
    if (AaAaaaaAA_or_Aaaa(a_a.A,a_a.A,AA_Aaaaa,AaaaAaaaa)) then  //aaaa aaa aaaaaa aaaa aaaa aaa aaaaa
      if ((a_a.a>(aaaa shl ?)) and (a_a.a<AaaaaAaa?.Aaaaa-(aaaa shl ?))) and ((a_a.a>(aaaa shl ?)) and (a_a.a<AaaaaAaa?.Aaaaaa-(aaaa shl ?))) then begin //aaaa aaaaaaaa aa aaaa AaaaaAaa aa aaaaaaaaaa aaaaaaa aaaaaaa( aaaaa aa aaaaaa aaaaaaaaa aaaaaaa aaaaaa aaaaa)
        ...
        if (AaaaaAaaaaaAaaaa) then begin                //aaaa aaaaa a aaaaaaaa aaaaa aaaaa aaaa aaaa aaa aaaaa,aa aaaaaaa aaaaaaa
          ...
          Aaaaaa_aaa_Aaaaaa(a_a.A,a_a.A,aaaaa_aaaa[A-?].Aaaaa,AaaAaAaa(A));  AaaaaAaa?.Aaaaaaaaaa();
          AaaaAaaaa_aaAaa.Aaaaa:=A;
          AaaaAaaaa_aaAaa.AaAaaa(nil);
    ...
    if not(AaAaaaaAA_or_Aaaa(a_a.A,a_a.A,AA_Aaaaa,AaaaAaaaa, Aaaa)) then begin   //aaaa aaa aaaaaa aa aaaa aaaa aaa aaaaa (a.a. aaaaaaa(aaaa aaaaaa aaaaaa aaaaaaa aa aaaaa aaaaa aaaa aaa aaaaa, aaaaaaa aaa aa aaaaaaaaa aaa aaaaaaa))
      ...
      if a > ? then begin
        if Aaa_A_Aaaa or ((AaaAaaAaaaa(AA_AAAA)<?) and (AaaAaaAaaaa(AA_AAAAAAA)<?)) then begin
          ...
          Aaaaaa_aaa_Aaaa(Aaaa_aaaaa[?],Aaaa_aaaaa[?],Aaaa_aaaaa[?],Aaaa_aaaaa[?]); AaaaaAaa?.Aaaaaaaaaa();
          ...
          Aaaaaa_aaaa(Aaaa_aaaaa[?],Aaaa_aaaaa[?]); AaaaaAaa?.Aaaaaaaaaa();
